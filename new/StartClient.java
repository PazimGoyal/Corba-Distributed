...
public class StartClient {
	static Eventmanagement interFace;
	/**
	 * @param args
	...
	public static Eventmanagement gettype(String abc) {
		try {
			if (abc.equals("TOR"))
				interFace = (Eventmanagement) EventmanagementHelper.narrow(ncRef.resolve_str("TOR"));
			else if (abc.equals("MTL"))
				interFace = (Eventmanagement) EventmanagementHelper.narrow(ncRef.resolve_str("MTL"));
			else
				interFace = (Eventmanagement) EventmanagementHelper.narrow(ncRef.resolve_str("OTW"));
		} catch (Exception e) {
