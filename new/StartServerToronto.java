...
public class StartServerToronto {
    static ImplementationToronto exportedObj;
    ...
    public static void main(String args[]) {
        try {
            ...
            ImplementationToronto addobj = new ImplementationToronto();
            addobj.setORB(orb);
            ...
            exportedObj = new ImplementationToronto();
            startUDPServer(8086);
